export default {
  ...
  contactForm: {
    ...
    messages: {
      ...
      messageContentMax: 'Message content must not be longer than 2000 characters.',
      ...
      messageSuccessSent: 'Your message has been sent successfully!',
      messageErrorSent: 'An error occurred while sending the message. Please try again later.',
    },
    messageTypes: {
